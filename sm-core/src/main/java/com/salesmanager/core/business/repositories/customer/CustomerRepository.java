...
public interface CustomerRepository extends JpaRepository<Customer, Long>, CustomerRepositoryCustom {
	...
	@Query("select distinct c from Customer c left join fetch c.wallet cw where cw.share like ?1")
	List<Customer> findByWalletShare(String shareId);
