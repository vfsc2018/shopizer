...
public class UserController {
	...
	public @ResponseBody
	ResponseEntity<String> resetPassword(@ModelAttribute(value="userReset") UserReset userReset,HttpServletRequest request,HttpServletResponse response,Locale locale) {
	...
	@RequestMapping(value="/admin/users/setCredentials.html", method=RequestMethod.POST)
	public @ResponseBody
	ResponseEntity<String> setCredentials(HttpServletRequest request,HttpServletResponse response,Locale locale) {
