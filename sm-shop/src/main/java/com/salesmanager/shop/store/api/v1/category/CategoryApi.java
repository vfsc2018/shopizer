...
public class CategoryApi {
	...
	@Cacheable(value=CacheNamesImpl.CACHE_CONTENT, key = "'categoryId_'  #categoryId")
	...
	@ApiImplicitParams({ @ApiImplicitParam(name = "store", dataType = "string", defaultValue = "DEFAULT"),
			@ApiImplicitParam(name = "lang", dataType = "string", defaultValue = "vi") })
	@Cacheable(value=CacheNamesImpl.CACHE_CONTENT, key = "'categoryList_' + #page + '_' + #count")
	public ReadableCategoryList list(
			@RequestParam(value = "filter", required = false, defaultValue = "visible") List<String> filter,
