...
<%@ page session="false" %>	
    ...
    {title:"<s:message code="label.order.startDate" text="Start date"/>", name:"startDate", canFilter:false},
    {title:"<s:message code="label.order.endDate" text="End date"/>", name:"endDate", canFilter:false},
    {title:"<s:message code="label.order.phone" text="Telephone"/>", name:"phone", canFilter:false},
