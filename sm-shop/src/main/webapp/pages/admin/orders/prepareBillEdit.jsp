...
<div class="tabbable">
		...
		<br/>
	     ...
	     <c:url var="sendBill" value="/admin/orders/sendBill.html"/>
	     
         <form:form method="POST" id="FormBuildBill" modelAttribute="order" action="${sendBill}">
										...
										<tr>
											<td colspan="2">
											      <table class="table table-bordered table-striped"> 
														...
														<tbody> 
															<c:forEach items="${entity.items}" var="subEntity" varStatus="counter2">	 
																<tr>
